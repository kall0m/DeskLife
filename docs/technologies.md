# Как е изграден DeskLife

Този документ обяснява на достъпен език основните технологии в проекта и как работят заедно.
...
- не се синхронизират автоматично между устройства;
- не се изпращат автоматично към сървър;
- се пазят като текст;
- не трябва да съдържат пароли или чувствителна информация.

DeskLife използва localStorage за завършените дневни задачи, избрания ден в статистиката, темата, резултатите от формите и калкулаторите.
...
Когато състоянието се промени, React обновява само необходимата част от интерфейса.
...
`layout.tsx` съдържа елементи, които трябва да присъстват на всички страници.

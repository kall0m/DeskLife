...
const plans: Record<PlanKey, Plan> = {
  ...
  intermediate: {
    title: "Средно напреднал: Push / Pull / Крака",
    ...
    days: [
      ...
      ["Сряда и Събота — Крака и корем", ["Клек — 4×6–8", "Румънска тяга — 3×10", "Лег преса — 3×10–12", "Прасци — 4×15", "Повдигане на краката — 3 серии"]],
    ],
    week: [
      { day: "Пон", label: "Push", training: true }, { day: "Вто", label: "Pull", training: true },
      { day: "Сря", label: "Крака", training: true }, { day: "Чет", label: "Push", training: true },
      { day: "Пет", label: "Pull", training: true }, { day: "Съб", label: "Крака", training: true },
      { day: "Нед", label: "Почивка", training: false },
    ],
  },
  advanced: {
